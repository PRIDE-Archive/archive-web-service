...
public class PsmController {
    ...
    PsmDetailList getPeptideBySequence(
        ...
        // ToDo: add paging, as some sequences queries can result in very large return lists
        List<Psm> foundPsms = psmSearchService.findByPeptideSequence(sequence, new PageRequest(page, showResults));
    ...
    PsmDetailList getPeptideByExtendedSequenceSearch(
        ...
        List<Psm> foundPsms = psmSearchService.findByPeptideSubSequence(sequence, new PageRequest(page, showResults));
    ...
    PsmDetailList getPeptidesByProject(
        ...
        List<Psm> foundPsms = psmSearchService.findByProjectAccession(projectAccession, new PageRequest(page, showResults)).getContent();
    ...
    PsmDetailList getProteinsByAssay(
        ...
        List<Psm> foundPsms = psmSearchService.findByAssayAccession(assayAccession, new PageRequest(page, showResults)).getContent();
...
@ApiOperation(value = "retrieve peptide identifications by protein accession", position = 4)
    ...
    PsmDetailList getProteinsByProtein(
        ...
        List<Psm> foundPsms = psmSearchService.findByProteinAccession(proteinAccession);
