...
//        List<Psm> foundPsms = psmSearchService.findByProjectAccession(projectAccession, new PageRequest(page, showResults)).getContent();
        List<Psm> foundPsms = psmSecureSearchService.findByProjectAccession(projectAccession, new PageRequest(page, showResults));
...
//        List<Psm> foundPsms = psmSearchService.findByAssayAccession(assayAccession, new PageRequest(page, showResults)).getContent();
        List<Psm> foundPsms = psmSecureSearchService.findByAssayAccession(assayAccession, new PageRequest(page, showResults));
